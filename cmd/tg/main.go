...
func main() {
	...
	app.Commands = []*cli.Command{
		{
			...
			UsageText:   "tg init [options] projectPath",
	...
	// hack that allows write options after arguments
	// urfave/cli cannot solve this issue https://github.com/urfave/cli/issues/427
	// but someone found solution in ipfs/ipget project
	// https://github.com/urfave/cli/issues/427#issuecomment-712292636
	err := app.Run(movePostfixOptions(os.Args))
	if err != nil {
		log.Fatal(err)
	}
}
