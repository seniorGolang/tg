...
func RingBufferOffset() (offset uint32) {
	return RingBufferHeaderSize
}

func ReadHeader(ctx context.Context, h memory.Host, bufferPtr uint32) (header *RingBufferHeader, err error) {
...
func WriteHeader(_ context.Context, h memory.Host, bufferPtr uint32, header *RingBufferHeader) (err error) {
...
func IsReadBufferEmpty(ctx context.Context, h memory.Host, bufferPtr uint32) (isEmpty bool, err error) {
...
func DestroyRingBuffer(ctx context.Context, h memory.Host, bufferPtr uint32) {
